        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthcareCenterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_HealthcareCenters_HealthcareCenterId",
                        column: x => x.HealthcareCenterId,
                        principalTable: "HealthcareCenters",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Receptionists_HealthcareCenters_HealthcareCenterId",
                        column: x => x.HealthcareCenterId,
                        principalTable: "HealthcareCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Staff_HealthcareCenters_HealthcareCenterId",
                        column: x => x.HealthcareCenterId,
                        principalTable: "HealthcareCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicationDetails = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DoctorId_ScheduledStart_ScheduledEnd",
                table: "Appointments",
                columns: new[] { "DoctorId", "ScheduledStart", "ScheduledEnd" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_HealthcareCenterId",
                table: "Patients",
                column: "HealthcareCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receptionists_HealthcareCenterId",
                table: "Receptionists",
                column: "HealthcareCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Staff_HealthcareCenterId",
                table: "Staff",
                column: "HealthcareCenterId");
